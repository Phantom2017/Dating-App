...
This package installs the .NET Core 3.1 runtime for your platform and provides the `dotnet` executable.

No elevation/root required.

Partners with the [dotnet-3.1](https://www.npmjs.com/package/dotnet-3.1) package.
